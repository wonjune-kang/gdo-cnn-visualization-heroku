...
"""
    Run this script locally after adding a new image to the /app/static/images
    directory to generate all of the outputs needed for visualization in the
    Data Observatory app. The title of the image should be its class label,
    and it should include an extension such as .jpg or .png.

    These changes will need to be pushed to the Heroku repository in order for
    them to go into effect.

    After generating all of the images, the new label should be added to the
    selectImage dropdown menu in the observatory control panel's
    control.html file.
"""
